...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """It should not Get a Product that does not found"""
        test_id = 0
    ...
    def test_update_product(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        new_product = response.get_json()
        new_product["description"] = "my test"
        response_updated = self.client.put(f"{BASE_URL}/{new_product['id']}", json=new_product)
        self.assertEqual(response_updated.status_code, status.HTTP_200_OK)
        updated_product = response_updated.get_json()
        self.assertEqual(updated_product["description"], "my test")
    ...
    def test_delete_product(self):
        ...
        response_get = self.client.get(f"{BASE_URL}/{test_product.id}")
